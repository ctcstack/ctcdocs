 ...
 */
export function createSyncConfigurationSchema(site) {
    return z.object({
...
export function parseSyncConfiguration(environment, site) {
    /*
     ...
     */
    const provided = Object.fromEntries(Object.entries(environment).filter(([, value]) => value !== ''));
