...
export declare function createSyncContext(repositoryRoot: string, site: SiteConfiguration): SyncContext;
/**
 ...
 * `package.json` runs.
 */
export declare function loadSyncContext(from?: string): SyncContext;
